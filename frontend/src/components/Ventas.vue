  ...
  <div class="table-container" >
    ...
    <tbody>
      <tr v-for="(producto, index) in productosfiltrando" :key="index">
                ...
                <td><button @click="traer(producto)" type="button" class="btn btn-dark" data-bs-toggle="modal" data-bs-target="#staticBackdrop" >Editar</button></td>
              </tr>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <div class="form-group">
            ...
            <div class="form-group">
              ...
              <input autocomplete="off" type="text" v-model="editarvalor" class="form-control" />
            </div>

            <div class="form-group">
              <label for="cantidad">Cliente</label>
              <input autocomplete="off" type="text" v-model="editarcliente" class="form-control" />
            </div>

            <div class="form-group">
              <label for="cantidad">Cantidad</label>
              <input v-model="editarcantidad" type="text">
            </div>
      ...
      <div class="modal-footer">
        ...
        <button type="button" @click="ediciondatos()" class="btn btn-dark">Guardar</button>
      </div>
    </div>
  </div>
</div>
...
let editarvalor = ref("")
let editarcantidad = ref("")
let editarcliente = ref("")
let idnecesario = ref("")
  ...
  editarvalor.value = producto.valor
  editarcantidad.value = producto.cantidad
  editarcliente.value = producto.cliente
  console.log(editarcliente.value);
}
...
if (validacionesedicion() == true) {
  ...
  console.log(editarcliente.value);
  const a = await useventas.actualizarVenta(
  idnecesario.value, 
  editarnombre.value,
  editarvalor.value,
...
if (!editarnombre.value) {
  ...
  }else if (!editarvalor.value) {
    alerta_v.value = "La descripcion es obligatoria";
  }else if (!editarcantidad.value) {
    alerta_v.value = "El precio es obligatorio";
  }else if (!editarcliente.value) {
    alerta_v.value = "El cliente es obligatorio";
  } else {
    alerta_v.value = "";
