<template>
  ...
  async function traecompras() {
    let cosa = await useproveedores.pedirproveedores();
  ...
  function traer(producto) {
    ...
    telefonomodel.value = producto.telefono
  }
  
  let validacion = ref(false);
  async function ediciondatos() {
    if (validacionesedicion() == true) {
      const a = await useproveedores.actualizarproveedor(
        idnecesario.value,
        nombremodel.value,
        valormodel.value,
        cantidadmodel.value,
